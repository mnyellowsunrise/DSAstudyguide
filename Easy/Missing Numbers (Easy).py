...
def missingNumber(nums):
    ...
    # which represents the missing number in the range [0, n]
    return expected_sum - actual_sum

#OR without using gauss formula using XOR

def missingNumber(nums):
    n = len(nums)
    # Initialize result with n, as it will account for the missing number
    result = n
